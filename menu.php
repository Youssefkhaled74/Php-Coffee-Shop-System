...
<body>
    <div class="container mt-5">
        <a class="btn btn-primary mt-5" href="./addmenu.php">Add to menu</a>
            ...
            <tbody>
                ...
                if ($resultselect) {
                    while ($row = mysqli_fetch_assoc($resultselect)) {
                        ...
                        <td>
                            <a href="updatem.php?updateid='.$id.'" class="btn btn-primary" >Update</a>
                            <a href="deletem.php?deleteid='.$id.'" class="btn btn-danger">Delete</a>
                        </td>
                        </tr>
                        ';
